/* =========================================================================
   writing-posts.js — the writing series as DATA, separated from the timeline
   logic (spa-writing.js). Edit content here; the renderer stays untouched.

   window.LB_WRITING_DATA = { shipped, posts }
     shipped : highest post number confirmed live (drives shipped/queued state)
     posts[] : { n, t (short title), ax (axis letters for the filter),
                 axn (axis label), hook (the post's one-line hook) }
   ========================================================================= */
(function(){
  "use strict";
  window.LB_WRITING_DATA = {
    shipped: 12,   // confirmed live as of the last review ("we are on post 12")
    posts: [
